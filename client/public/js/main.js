...
(function($) {
  ...
  $("#price-range-P").slider({
    ...
    slide: function(event, ui) {
      $("#priceRangeP").val(
        "[ " + "Ksh" + ui.values[0] + " - " + "Ksh" + ui.values[1] + " ]"
      );
    }
  });
  $("#priceRangeP").val(
    "[ " +
      "Ksh" +
      $("#price-range-P").slider("values", 0) +
      " - " +
      "Ksh" +
      $("#price-range-P").slider("values", 1) +
      " ]"
  );
  ...
  $("#roomsize-range-P").slider({
    ...
    slide: function(event, ui) {
      $("#roomsizeRangeP").val(
        "[ " + ui.values[0] + " Fqft" + " - " + ui.values[1] + " Fqft" + " ]"
      );
    }
  });
  $("#roomsizeRangeP").val(
    "[ " +
      $("#roomsize-range-P").slider("values", 0) +
      " Fqft" +
      " - " +
      $("#roomsize-range-P").slider("values", 1) +
      " Fqft" +
      " ]"
  );
