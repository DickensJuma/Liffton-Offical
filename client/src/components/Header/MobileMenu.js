                  ...
                  <div className='nav-dropdown-content'>
                    <ul className='nav-dropdown-sections'>
                      <li className='nav-dropdown-section'>
                        <h6 className='nav-dropdown-header'>Nairobi homes for Rent</h6>
                        <ul className='nav-dropdown-columns'>
                          <li className='nav-dropdown-column'>
                            <ul className='nav-dropdown-links'>
                              <li><a href='/property' className='nav-link-text'><span>Homes For Rent</span></a></li>
                      ...
                      <li className='nav-dropdown-section'>
                        ...
                        <ul className='nav-dropdown-columns'>
                          <li className='nav-dropdown-column'>
                            <ul className='nav-dropdown-links'>
                              <li><a href='/property' className='nav-link-text'><span>Tenant Guide</span></a></li>
