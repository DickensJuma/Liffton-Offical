                      ...
                      <div className='row'>
                        ...
                        <div className='col-md-9'>
                          <div className='user-details'>
                            <span className='user-name'>LIffton Holdings</span>
                ...
                <div className='listing'>
                  <div className='listing-img' style={{ background: `url(${property.image} no-repeat center center` }}>
                    ...
                    <div className='details'>
                      ...
                      <div className='col-md-9'>
                        <div className='user-details'>
                          <span className='user-name'>Jack Ouma</span>
                          <span className='post-date'>05/02/202</span>
                        </div>
                  ...
                  <div className='details'>
                    <div className='container'>
                      <div className='row'>
                        ...
                        <div className='col-md-9'>
                          <div className='user-details'>
                            <span className='user-name'>Kennedy Otieno </span>
                            <span className='post-date'>05/04/2020</span>
                          </div>
                          <div className='listing-details'>
                            <div className='floor-space'><i className='fa fa-square-o' aria-hidden='true' /> <span>{property.floorSpace} ft&sup2;</span></div>
                            <div className='bedrooms'>
              ...
              <div className='listing'>
                <div className='listing-img' style={{ background: `url(${property.image}) no-repeat center center` }}>
                  ...
                  <div className='details'>
                    ...
                    <div className='col-md-9'>
                      <div className='user-details'>
                        <span className='user-name'>Jack Kinuthia </span>
                        <span className='post-date'>05/03/2020</span>
                      </div>
