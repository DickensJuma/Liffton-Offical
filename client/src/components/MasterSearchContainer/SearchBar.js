...
class SearchBar extends Component {
  ...
  handleInputChange(event, allProperties, listingType, numOfBeds, homeType) {
    ...
    if (numOfBeds >= 0) this.setState({ bedrooms: numOfBeds });

    if (this.state.homeType) this.setState({ bedrooms: numOfBeds });
      ...
      <div id="search-bar-container" className="">
        <ul className="toolbar-left">
          <li className="search-box-content">
            <form className="searchbox" id="">
              <label className="hide-visually" htmlFor="citystatezip">
                Search
              </label>
              <input
                autoCorrect="off"
                name="citystatezip"
                id="citystatezip"
                placeholder="Location, Neighborhood or Town"
                type="text"
                className="aclist-input"
                autoComplete="off"
              />
          ...
          <li id="search-sort-bar" className="zsg-nav-item">
            <div id="search-filters" className="zsg-nav-item search-filters">
              <form id="searchfilters" className="zsg-form">
                <fieldset className="filter-menu listings-menu">
                  <legend>
                    <a href="#/" className="menu-label" tabIndex="0">
                      <div
                        id="listings-menu-label"
                        onClick={() =>
                          this.menuItemClicked("listings-menu-label")
                        }
                      >
                        <span className="zsg-icon-for-sale">&nbsp;</span>
                        <span className="zsg-icon-pre-market">&nbsp;</span>
                        Listing Type
                          ...
                          <li id="fs-listings" className="listing-type">
                            <div className="listing-category">
                              ...
                              <label htmlFor="fs-listings-input">
                                <span className="icon-for-sale">&nbsp;</span>
                                <span className="listing-type-text">
                                  For Sale{" "}
                                </span>
                                <span id="fs-listings-resultCountWrapper">
                                  (44)
                                </span>
                              </label>
                            </div>
                          ...
                          <li id="fr-listings" className="listing-type">
                            <div className="listing-category">
                              ...
                              <label htmlFor="fr-listings-input">
                                <span className="icon-for-rent">&nbsp;</span>
                                <span className="listing-type-text">
                                  For Rent{" "}
                                </span>
                                <span id="fr-listings-resultCountWrapper">
                                  (110)
                                </span>
                              </label>
                            </div>
                          ...
                          <li id="rs-listings" className="listing-type">
                            <div className="listing-category">
                              ...
                              <label htmlFor="rs-listings-input">
                                <span className="icon-recently-sold">
                                  &nbsp;
                                </span>
                                <span className="listing-type-text">
                                  Recently Rented{" "}
                                </span>
                                <span id="rs-listings-resultCountWrapper">
                                  (58)
                                </span>
                              </label>
                            </div>
                ...
                <fieldset className="filter-menu affordability-menu price-menu">
                  <legend data-za-label="Price">
                    ...
                    >
                      <div
                        id="price-menu-label"
                        onClick={() => this.menuItemClicked("price-menu-label")}
                      >
                        {" "}
                        Any Price <span className="zsg-icon-arrow-menu-down" />
                        <i className="fas fa-sort-down" />
                        <i className="fas fa-sort-up" />
                      </div>
                    </a>
                  ...
                  <div className="filter-pane pricing-pane">
                    <div
                      id="price-entries"
                      className="price-entries search-entry"
                    >
                    ...
                    <div className="filter-price">
                      <div
                        id="price-min-options"
                        className="price-options min-price-options custom-dropdown"
                        data-dropdown-id="price-min"
                      >
                        <ul className="dropdown-options search-entry menu-linklist">
                          <li data-value="">
                            <a href="#/" className="option" tabIndex="0">
                              0
                            </a>
                          </li>
                          <li data-value="5,000">
                          ...
                          <li data-value="10,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 10,000+
                            </a>
                          </li>
                          <li data-value="15,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 15,000+
                            </a>
                          </li>
                          <li data-value="20,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 20,000+
                            </a>
                          </li>
                          ...
                          <li data-value="30,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 30,000+
                            </a>
                          </li>
                          <li data-value="40,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 40,000+
                            </a>
                          </li>
                      ...
                      <div
                        id="price-max-options"
                        className="price-options max-price-options custom-dropdown hide"
                      ...
                      >
                        <ul className="dropdown-options search-entry menu-linklist">
                          ...
                          <li data-value="60,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 60,000
                            </a>
                          </li>
                          <li data-value="70,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 70,000
                            </a>
                          </li>
                          <li data-value="80,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 80,000
                            </a>
                          </li>
                          <li data-value="90,000">
                            <a href="#/" className="option" tabIndex="0">
                              Ksh 90,000
                            </a>
                          </li>
                ...
                <fieldset
                  data-dropdown-id="beds-select"
                  className="filter-menu beds-menu custom-dropdown"
                  id=""
                >
                  <legend data-za-label="Beds">
                    <a href="#/" id="" className="menu-label" tabIndex="0">
                      <div
                        id="beds-menu-label"
                        onClick={() => this.menuItemClicked("beds-menu-label")}
                      >
                        <span className="options-display" data-za-action="Beds">
                          0+
                        </span>{" "}
                        Beds
                        <i className="fas fa-sort-down" />
                ...
                <fieldset className="filter-menu home-type-menu hometype-standalone custom-dropdown home-type-dropdown">
                  <legend data-za-label="Home Type">
                    <a href="#/" id="" className="menu-label" tabIndex="0">
                      <div
                        id="housetype-menu-label"
                        onClick={() =>
                          this.menuItemClicked("housetype-menu-label")
                        }
                      >
                        {" "}
                        Home Type <span id="hometype-count" />
                        <i className="fas fa-sort-down" />
                        <i className="fas fa-sort-up" />
                      </div>
                    </a>
                  ...
                  <div className="filter-pane housetype-pane" id="">
                    <ul
                      className="combobox-options multicheck-dropdown-options hometype-options"
                      id=""
                    >
                      <li
                        id="hometype-houses-filters"
                        className="hometype-houses selected"
                      >
                        <input
                          name="houseType"
                          tabIndex="-1"
                          id="hometype-houses-filters-input"
                          type="radio"
                        ...
                        <label htmlFor="hometype-houses-filters-input">
                          <span
                            id="hometype-houses-filters-label"
                            className="hometype-houses-label option"
                          >
                            Houses
                          </span>
                        </label>
                      ...
                      <li
                        id="hometype-apart-filters"
                        className="hometype-apart selected"
                      >
                        <input
                          name="houseType"
                          tabIndex="-1"
                          id="hometype-apart-filters-input"
                          type="radio"
                        ...
                        />
                        <label htmlFor="hometype-apart-filters-input">
                          <span
                            id="hometype-apart-filters-label"
                            className="hometype-apart-label option"
                          >
                            Apartments
                          </span>
                        </label>
                      ...
                      <li
                        id="hometype-condo-filters"
                        className="hometype-condo selected"
                      >
                        <input
                          name="houseType"
                          tabIndex="-1"
                          id="hometype-condo-filters-input"
                          type="radio"
                        ...
                        <label htmlFor="hometype-condo-filters-input">
                          <span
                            id="hometype-condo-filters-label"
                            className="hometype-condo-label option"
                          >
                            Condos
                          </span>
                        </label>
                      ...
                      <li
                        id="hometype-townhome-filters"
                        className="hometype-townhome selected"
                      >
                        <input
                          name="houseType"
                          tabIndex="-1"
                          id="hometype-townhome-filters-input"
                          type="radio"
                        ...
                        <label htmlFor="hometype-townhome-filters-input">
                          <span
                            id="hometype-townhome-filters-label"
                            className="hometype-townhome-label option"
                          >
                            Townhomes
                          </span>
                        </label>
                      ...
                      <li
                        id="hometype-land-filters"
                        className="hometype-land selected"
                      >
                        <input
                          name="houseType"
                          tabIndex="-1"
                          id="hometype-land-filters-input"
                          type="radio"
                        ...
                        <label htmlFor="hometype-land-filters-input">
                          <span
                            id="hometype-land-filters-label"
                            className="hometype-land-label option"
                          >
                            Estates
                          </span>
                        </label>
                ...
                <fieldset className="filter-menu more-menu">
                  <legend data-za-label="More">
                    <a href="#/" className="menu-label" tabIndex="0">
                      <div
                        id="more-menu-label"
                        onClick={() => this.menuItemClicked("more-menu-label")}
                      >
                        {" "}
                        More
                  ...
                  <div className="filter-pane more-pane" id="">
                    <div id="baths-entries" className="search-entry">
                      ...
                      <div
                        id="baths-dropdown"
                        className="combobox custom-dropdown"
                        tabIndex="0"
                      >
                        <span
                          id="baths-readout"
                          className="options-display"
                          data-za-action="Baths"
                        >
                          1.5+
                        </span>
                        ...
                        <ul id="bath-options" className="dropdown-options">
                          <li data-value="," id="">
                            <a href="#/" className="option" tabIndex="-1">
                              0+
                            </a>
                          </li>
                          <li data-value="1.," id="">
                          ...
                          <li data-value="1.5," id="" className="selected">
                            <a href="#/" className="option" tabIndex="-1">
                              1.5+
                            </a>
                          </li>
                    ...
                    <div id="lot-size-entries" className="search-entry">
                      ...
                      <div
                        id="lot-min-dropdown"
                        className="combobox custom-dropdown"
                        data-dropdown-id="lot-size-select"
                        tabIndex="0"
                      >
                        <span
                          id="lot-size-select-readout"
                          className="options-display"
                          data-za-action="Change - Lot Size"
                        >
                          Any
                        </span>
                        <span className="icon-arrow-menu-down"></span>
                        <ul id="lot-size-select-options" className="">
                          <li data-value="," id="" className="selected">
                            <a href="#/" className="option" tabIndex="-1">
                              Any
                            </a>
                          </li>
                      ...
                      <select id="lot-size-select" className="hide">
                        ...
                        <option value="200,">2,000+ sqft</option>
                        <option value="300,">3,000+ sqft</option>
                        <option value="400,">4,000+ sqft</option>
                        <option value="500,">5,000+ sqft</option>
                        <option value="750,">7,500+ sqft</option>
                        <option value="1089,">.25+ acre / 1,890+ sqft</option>
                        <option value="2178,">.5+ acre / 21,780+ sqft</option>
                        <option value="4356,">1+ acre</option>
                        <option value="8712,">2+ acres</option>
                        <option value="21780,">5+ acres</option>
                        <option value="43560,">10+ acres</option>
                      </select>
                          ...
                          <ul className="form-group radio-buttons">
                            ...
                            <li>
                              <input
                                ...
                                value="acre"
                              />
                              <label htmlFor="custom-lot-acre">Acre</label>
                            </li>
                          </ul>
                        </div>
                        <div className="dualboxes">
                    ...
                    <div
                      id="yearbuilt-entries"
                      className="search-entry"
                      data-za-label="Year Built"
                    >
                    ...
                    <div id="days-entries" className="search-entry">
                      <div id="days-on-title" className="title">
                        Days on Lifflon Housing
                      </div>
                      <div
                        id="days-dropdown"
                        className="combobox custom-dropdown"
                        data-dropdown-id="days-on-select"
                        tabIndex="0"
                      >
                        <span
                          id="days-readout"
                          className="options-display"
                          data-za-action="Days on Trillo"
                        >
                          14 days
                        </span>
                        ...
                        <ul
                          id="days-options"
                          className="dropdown-options combobox-options zsg-menu-linklist"
                        >
                          <li data-value="any" id="">
                            <a href="#/" className="option" tabIndex="-1">
                              Any
                            </a>
                          </li>
                          ...
                          <li data-value="14" id="" className="selected">
                            <a href="#/" className="option" tabIndex="-1">
                              14 days
                            </a>
                          </li>
                    ...
                    <div id="attribute-entry" className="search-entry">
                      ...
                      <textarea
                        id="attribute-terms"
                        placeholder="Garage, pool, waterfront, etc."
                      ></textarea>
                    </div>
                    <a
                      href="#/"
        ...
        <ul className="toolbar-right">
          <li id="save-search-button">
            <fieldset className="filter-menu save-search">
              <legend data-za-label="Save search">
                <a
                  href="#/"
                  data-za-label-submit="Save Search Toolbox submit"
                  className="lightbox-show zsg-link_primary"
                  data-za-label="Save search"
                >
                  Save Search
                </a>
              </legend>
          ...
          <li id="fav-control-myhome" className="search-nav-button">
            <a
              href="#/"
              data-za-category="Search"
              data-za-action="Saved Homes Click"
              rel="nofollow"
              data-after-auth-action-type="Link"
              id="register_opener"
              title="Saved Homes"
              className="toolbar-button zsg-button_primary track-ga-event show-lightbox"
              data-za-label="SavedHomes Map"
            >
              {" "}
              Saved Homes (
              <span data-count="0" id="saved-homes-count">
                0
              </span>
              ){" "}
            </a>
